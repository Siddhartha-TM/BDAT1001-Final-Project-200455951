...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var serverResponse = await AccessTokenRefreshWrapper(() => SecuredGetRequest("https://localhost:44316/secret/index"));
            var apiResponse = await AccessTokenRefreshWrapper(() => SecuredGetRequest("https://localhost:44346/secret/index"));
            return View();
        }
        ...
        private async Task RefreshAccessToken()
        {
            ...
            var refreshTokenClient = client.CreateClient();
            var requestData = new Dictionary<string, string>
            {
                ["grant_type"] = "refresh_token",
                ["refresh_token"] = refreshToken
            };
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:44316/oauth/token")
            {
